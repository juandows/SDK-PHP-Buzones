...
{
    /**
     * @var BoxesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return BoxesController The *Singleton* instance.
     */
     ...
     */
    public function getApplicationsIris2BoxesGet(
        $token
    ) {
        ...
        $_queryBuilder = $_queryBuilder.'/applications/iris2/boxes';
